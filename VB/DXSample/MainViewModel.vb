...
Namespace DXSample
    ...
    Public Class MainViewModel
        ...
        Public Sub New()
            Items = New ObservableCollection(Of UserControlViewModel)() From {New UserControlViewModel() With {.ViewName = "UserControl1"}, New UserControlViewModel() With {.ViewName = "UserControl2"}, New UserControlViewModel() With {.ViewName = "UserControl3"}, New UserControlViewModel() With {.ViewName = "HomeView"}}
        End Sub
    End Class
End Namespace
